...
class Wordsdearch2 {
    ...
    public static void Easy_answers (int num){
    ...
    public static void Medium_answers (int num){
        long startTime = System.currentTimeMillis();
        
        System.out.println();
        String a[] = {"6,1.0,1", "7,3.1,3", "3,9.8,9", "6,0.1,0","8,0.8,7", "7,5.4,5", "9,4.9,9", "6,7.0,7", "8,8.2,8", "0,6.6,6"};
        boolean correct = false;
        int left = num;
        while (left>0){
            String x = sc.next();
    ...
    public static void Words3_Answers (int num){
        long startTime = System.currentTimeMillis();
